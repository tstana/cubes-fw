...
/* HK ADC 7-bit (unshifted) Address options - GND one is used for slave addressing */
#define HK_ADC_ADDRESS_GND          0x48
#define HK_ADC_ADDRESS_VDD          0x49
#define HK_ADC_ADDRESS_SDA          0x4A
#define HK_ADC_ADDRESS_SCL          0x4B
